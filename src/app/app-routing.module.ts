...
const routes: Routes = [
  ...
  {path:"modifier-voiture/:id",component:AjouterVoitureComponent,canActivate: [AuthGuard],data: { expectedRole: ['admin'] }},
  {path:"modifier-agence/:id",component:AjouterAgenceComponent,canActivate: [AuthGuard],data: { expectedRole: ['admin'] }},
  {path:"comptes",component:ComptesComponent,canActivate: [AuthGuard],data: { expectedRole: ['admin', 'manager'] }},
  {path:"ajouter-agence",component:AjouterAgenceComponent,canActivate: [AuthGuard],data: { expectedRole: ['admin'] }},
  {path:"agences",component:AgencesComponent,canActivate: [AuthGuard],data: { expectedRole: ['admin', 'manager'] }},
  ...
  {path:"inbox",component:InboxComponent,canActivate: [AuthGuard],data: { expectedRole: ['admin', 'manager'] }},
