...
const routes: Routes = [
  ...
  {path:"ajouter-compte",component:CreerCompteComponent , canActivate: [AuthGuard],data: { expectedRole:['admin', 'manager'] }},
  {path:"modifier-compte/:id",component:CreerCompteComponent,canActivate: [AuthGuard],data: { expectedRole: ['admin', 'manager'] }},
